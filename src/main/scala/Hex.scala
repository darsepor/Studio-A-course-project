...
//Setting up some tile types, at the time of writing this the difference between Plain and Hill is
//Purely cosmetic and Fort stands unimplemented.
...
//Helper object with some hexagon-grid math.
